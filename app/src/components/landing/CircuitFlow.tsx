...
const STAGES = [
  {
    ...
    detail: "An SPL token that represents a share. Held in custody, not synthesised.",
    beat: "Identify",
  },
  {
    key: "oracle",
    label: "Oracle",
    detail: "A Pyth price update, checked for age and for how wide its confidence interval is.",
    beat: "Verify",
  },
  {
    key: "market",
    label: "Market",
    detail: "The underlying venue's own session state. Open, closed, or halted.",
    beat: "Verify",
  },
  {
    key: "risk",
    label: "Risk",
    detail: "Loan-to-value and liquidation thresholds, configured per asset rather than globally.",
    beat: "Measure",
  },
  {
    key: "credit",
    label: "Credit",
    detail: "Borrowing power, released only once everything above agrees.",
    beat: "Authorize",
  },
];
