...
const VARIANT_MESSAGES: Record<string, string> = {
  ...
  ConfidenceTooWide:
    "Oracle uncertainty is too high, so the price is not considered reliable.",
  ...
  BorrowDisabledByRiskPolicy: "Blocked by your current risk limits.",
  WithdrawDisabledByRiskPolicy: "Blocked by your current risk limits.",
  EffectiveLtvExceeded: "Proposed operation exceeds effective LTV capacity under current risk state.",
  AgentAuthorityExpired: "The autonomous agent's delegated access has expired.",
  AgentActionNotPermitted: "The autonomous agent is not authorized to execute this action.",
  AgentBorrowLimitExceeded: "Requested borrow exceeds the agent's delegated credit limit.",
  AgentWithdrawLimitExceeded: "Requested withdrawal exceeds the agent's delegated limit.",
